            ...
            <div className="pointer-events-none fixed inset-y-0 right-0 flex max-w-full pl-10">
              ...
              >
                <Dialog.Panel className="pointer-events-auto w-screen max-w-md">
                  <div className="flex h-full flex-col overflow-y-scroll bg-purple shadow-xl">
                        ...
                        <div className="flow-root">
                          ...
                          >
                            {cartItems ? (
                              ...
                              <div className="w-full flex justify-center items-center md:pt-10 pt-2">
                                <p>Your cart is empty</p>
                              </div>
                            )}
                          </ul>
                        </div>
                      </div>) : (<div>Login to access your cart</div>)}
